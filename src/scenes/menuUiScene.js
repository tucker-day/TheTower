...
class MenuUiScene extends BaseScene {
    ...
    createMain() {
        ...
        this.menuGroup.addMultiple([
            ...
            this.createText(this.screenCenter[0], this.config.height * 0.47, 'Start Game', this.defaultFont(60), () => { 
    ...
    createCredits() {
        ...
        this.menuGroup.addMultiple([
            ...
            this.createText(this.screenCenter[0], this.config.height * 0.75, 'Game Programmed by Tucker Day', this.defaultFont(45)),
            this.createText(this.screenCenter[0], this.config.height * 0.9, 'Back to Menu', this.defaultFont(60), this.createMain)
        ])
    }
}

export default MenuUiScene